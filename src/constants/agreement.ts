export const agreement = {
    agree: `회원가입약관 제 1 장 : 총칙 제 2 장 : 서비스 이용계약 제 3 장 : 계약당사자의 의무 제 4 장 :
  서비스 이용 제 5 장 : 계약해지 및 이용제한 제 6 장 : 기타 제1장 총 칙 제1조(목적) 이 약관은 Zoo
  Diary 에서 제공하는 모든 서비스의 이용조건 및 절차에 관한 사항을 규정함을
  ...
  관할법원으로 합니다. 부 칙 (시행일) 이 약관은 2023년 10월 14일부터 시행합니다.`,
    privacy: `개인정보 수집 및 이용 1, 목적(이용자 식별 및 본인여부 확인), 항목(아이디, 닉네임, 비밀번호,
